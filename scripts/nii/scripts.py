...
#         graphs_spec('/Volumes/Storage/VCTK/data/inter-module/mcep/England/p274/p274_024.spec', dtype='<f4', frame=frame)
        blue_name = 'Gaussian_2696_1.spec.unwarp.f8'
        file_name = 'Gaussian_2696_1_full_picture'
        green_name='2696_1.spec.unwarp.f8'
#         red_name = '1119_1.spec.map2.f4'
#         blue = None
#         orig=
        blue = '/Volumes/Storage/generated_specs/Laura/warp_specs/%s'%blue_name
...
#         red='/Volumes/Storage/models/mapper/%s'%red_name
        ...
        graphs_spec(blue_path=blue, file_name=file_name, red_path=None, green_path=green, blue_type='<f8', red_type='<f8', green_type='<f8',
